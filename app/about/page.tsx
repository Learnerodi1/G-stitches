...
const stickyPanels = [
  {
    ...
    content: (
      <div>
        ...
        <p className="text-ground/60 leading-relaxed font-sans">
    ...
    <div>
      ...
      >
        <div className="text-center px-6">
          ...
          <FadeUp delay={0.5}>
            <p className="text-ivory/70 max-w-lg mx-auto mt-6 text-center font-sans">
      ...
      <section className="bg-ground py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 [&_span]:text-ivory [&_p]:text-ivory/70">
        ...
        <FadeUp>
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-ground/60 leading-relaxed mb-4 font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <FadeUp key={t.name} delay={i * 0.15}>
                <div className="bg-ivory/5 rounded-sm p-6 border border-antique-gold/10 text-left h-full backdrop-blur-sm">
